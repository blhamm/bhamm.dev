...
We provide a utility script to convert your `.p8` file into a safe format for `.env` files by converting newlines to literal characters and base64 encoding the result.
...
The application will automatically decode and normalize the key at runtime.

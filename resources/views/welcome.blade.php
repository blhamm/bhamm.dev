...
<main id="app" class="relative z-10">
	...
	<section id="hero" class="relative flex h-screen flex-col items-center justify-end overflow-hidden">
		...
		<div class="z-20 mb-8 md:mb-4 flex flex-col items-center gap-4 text-center">
			...
			<p class="scroll-helper-text text-pale-night-black/70 dark:text-pale-night-white/70 text-xs font-bold uppercase tracking-widest opacity-0">
		...
		<div class="terminal-parallax-wrapper relative z-10 mx-auto w-full max-w-5xl translate-y-24 md:translate-y-12">
			<div
				...
				<div
					class="terminal-header flex items-center border-b border-pale-night-black/5 dark:border-white/10 px-8 py-6">
				...
				<section id="kit" class="space-y-8">
					...
					<x-bento-grid>
						...
						<a href="https://www.apple.com/macbook-pro/" target="_blank"
						   class="group relative flex min-h-[350px] flex-col justify-end overflow-hidden rounded-3xl border border-pale-night-black/15 dark:border-white/10 px-6 py-8 sm:p-8 md:col-span-8 md:row-span-2 transition-all hover:ring-2 hover:ring-pale-night-teal dark:hover:ring-pale-night-purple">
...
{{--									class="absolute inset-0 z-10"></div>--}}
							...
							<div class="relative z-20 space-y-2">
								<div class="flex items-center gap-3">
									<flux:icon.cpu-chip class="size-6 text-pale-night-purple"/>
									<span class="text-pale-night-black dark:text-pale-night-white text-xs font-bold uppercase tracking-[0.2em]">Bleeding Edge</span>
								</div>
								<flux:heading level="3" size="xl" class="text-pale-night-black dark:text-pale-night-white">14" MacBook Pro M5</flux:heading>
								<p class="text-pale-night-purple max-w-md">
									Space Black Running the latest macOS 27 Developer Beta.
								</p>
							</div>
						</a>
						...
						<a href="https://junie.jetbrains.com" target="_blank"
						   class="glass-pane group relative overflow-hidden rounded-3xl px-6 py-8 sm:p-8 transition-all hover:ring-2 hover:ring-pale-night-green/50 md:col-span-4 md:row-span-2">
							...
							<div
								class="absolute -right-8 -bottom-8 size-32 bg-pale-night-green/10 blur-3xl transition-transform duration-700 group-hover:scale-150"></div>
						</a>

						{{-- Row 2 --}}
						<a href="https://ghostty.org/" target="_blank"
						   class="glass-pane flex flex-col justify-between rounded-3xl px-6 py-8 sm:p-8 transition-all hover:ring-2 hover:ring-pale-night-blue md:col-span-4">
						...
						<a href="https://typeof.net/Iosevka/" target="_blank"
						   class="glass-pane flex flex-col justify-between rounded-3xl px-6 py-8 sm:p-8 transition-all hover:ring-2 hover:ring-pale-night-teal/50 md:col-span-4">
							...
							<div>
								<h3 class="font-brand font-black text-3xl">Iosevka</h3>
						...
						<a href="https://www.apple.com/airpods-max/" target="_blank"
						   class="glass-pane group relative flex flex-col justify-end overflow-hidden rounded-3xl px-4 py-6 sm:p-6 transition-all hover:ring-2 hover:ring-white/50 md:col-span-4">
							<div class="absolute inset-0 z-0 overflow-hidden">
								<div
									class="absolute inset-0 z-10"></div>
								<img src="/images/kit/airpods-max-midnight.svg" alt="AirPods Max"
								     class="relative h-full w-full object-cover transition-transform duration-700 group-hover:scale-110 left-28"/>
							</div>
							<div class="relative z-20 text-pale-night-black dark:text-pale-night-white">
								<flux:heading level="4" size="sm" class="">AirPods Max</flux:heading>
								<span class="text-[10px] uppercase">Midnight</span>
							</div>
						</a>
						...
						<a href="https://www.lg.com/us/monitors/lg-27md5kl-b-5k-uhd-led-monitor" target="_blank"
						   class="glass-pane flex items-center gap-6 rounded-3xl px-6 py-8 sm:p-8 transition-all hover:ring-2 hover:ring-pale-night-purple/50 md:col-span-4">
							...
							<div>
								...
								<p class="text-pale-night-black/60 dark:text-pale-night-white/60">
									27-inch of pixel-perfect clarity paired with a Twelve South Curve Flex stand, for my
									MacBook.
								</p>
							</div>
						</a>
						...
						<a href="https://www.apple.com/shop/product/mxk83ll/a/magic-keyboard-with-touch-id-and-numeric-keypad-for-mac-models-with-apple-silicon-usb-c-us-english-black-keys?fnode=fe58c85239c2b55071c25a9c5474fc35e7341577fbd6514d381d67dbe710ef38f04ec873ba1c335cb614d0c27c28697816142834d421e64e6376934eb9e64c7756028c552485599caa61bd7e476513a9531faa7c5ea790c99c97ee178646ea95"
						   target="_blank"
						   class="glass-pane flex flex-col justify-between rounded-3xl px-4 py-6 sm:p-6 transition-all hover:ring-2 hover:ring-pale-night-blue/50 md:col-span-4">
							<div class="absolute inset-0 z-0 overflow-hidden rounded-3xl">
								<div
									class="absolute inset-0 z-10"></div>
								<img src="/images/kit/magic-keyboard.webp" alt="Magic Keyboard"
								     class="group relative h-full w-full object-contain transition-transform duration-700 scale-75 md:scale-100 group-hover:scale-110 left-40 md:left-0 md:top-16 overflow-hidden"/>
							</div>
							<div>
								<flux:heading level="4" size="sm">Magic Peripherals</flux:heading>
								<span
									class="text-pale-night-black/40 dark:text-pale-night-white/40 text-[10px] uppercase">Touch ID Black</span>
							</div>
						</a>
						...
						<div
							class="glass-pane flex flex-col items-center justify-center space-y-4 rounded-3xl px-6 py-8 sm:p-8 text-center md:col-span-4">
							<div class="flex gap-4">
								...
								<a href="https://obsidian.md/" target="_blank">
									<img src="https://cdn.simpleicons.org/obsidian/c792ea" alt="Obsidian"
									     class="size-12 grayscale transition-all hover:grayscale-0"/>
								</a>
							</div>
							<div>
						...
						<a href="https://paktbags.com/products/everyday-22l-backpack" target="_blank"
						   class="glass-pane flex items-center gap-6 rounded-3xl px-6 py-8 sm:p-8 transition-all hover:ring-2 hover:ring-zinc-500/50 md:col-span-4">
							<div class="flex items-center">
								...
								<img src="/images/kit/packt-black.webp" alt="Pakt"
								     class="h-auto w-10 block dark:hidden"/>
							</div>
							<div>
						   ...
						   class="group flex flex-col items-center justify-center gap-6 rounded-3xl border border-red-500/20 bg-red-500/5 px-6 py-8 sm:p-8 backdrop-blur-md transition-all hover:bg-red-500/20 md:col-span-12 md:flex-row dark:bg-red-500/10">
							...
							<div class="text-center md:text-left">
								<flux:heading level="3" size="lg"
								              class="font-black uppercase tracking-[0.3em] text-red-500">Microsoft
									Restricted Zone
								</flux:heading>
...
<x-modal name="frontend-modal" title="Frontend Architecture & Design Systems" titleClass="text-gradient-fe" :tags="['Vue', 'React', 'TypeScript', 'Tailwind', 'Figma', 'GSAP']">
	<x-slot name="animation">
		<x-expertise.frontend/>
	</x-slot>
	<p>
...
<x-modal name="api-modal" title="API & Backend System Design" titleClass="text-gradient-api" :tags="['REST', 'OAuth', 'Redis', 'Event-Driven', 'JSON:API', 'Webhooks']">
	<x-slot name="animation">
		<x-expertise.api/>
	</x-slot>
	<p>
...
<x-modal name="database-modal" title="Database Mastery & Data Layer" titleClass="text-gradient-db" :tags="['PostgreSQL', 'MySQL', 'Redis', 'SQLite', 'Data Modeling', 'Optimization']">
	<x-slot name="animation">
		<x-expertise.database/>
	</x-slot>
	<p>
...
<x-modal name="devops-modal" title="DevOps, Deployment & Infrastructure" titleClass="text-gradient-devops" :tags="['Docker', 'AWS', 'GitHub Actions', 'Ansible', 'CI/CD']">
	<x-slot name="animation">
		<x-expertise.devops/>
	</x-slot>
	<p>
...
<x-modal name="observability-modal" title="Observability & System Reliability" titleClass="text-gradient-obs" :tags="['Grafana', 'OTLP', 'Observability', 'SRE', 'Prometheus', 'Logging']">
	<x-slot name="animation">
		<x-expertise.observability/>
	</x-slot>
	<p>
...
<x-modal name="engineering-modal" title="Engineering Standards & Craft" titleClass="text-gradient-eng" :tags="['Testing', 'SOLID', 'PHPStan', 'TypeScript', 'Clean Code', 'Refactoring']">
	<x-slot name="animation">
		<x-expertise.engineering/>
	</x-slot>
	<p>

...
<body class="bg-pale-night-white dark:bg-pale-night-black text-pale-night-black dark:text-pale-night-white min-h-screen antialiased">
    <div class="relative grid h-dvh flex-col items-center justify-center px-8 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div class="bg-pale-night-white/10 relative hidden h-full flex-col p-10 text-white lg:flex dark:border-e dark:border-zinc-800">
            <div class="bg-pale-night-black absolute inset-0"></div>

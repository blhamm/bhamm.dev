<div class="expertise-animation-container absolute inset-0 z-0 opacity-70 dark:opacity-60 scale-80 md:scale-100 origin-bottom-right translate-x-12 translate-y-6 md:translate-x-20 md:translate-y-10" data-type="observability">
